...
@Entity(tableName = "meal_table", indices = [Index(value = ["idMeal"], unique = true)]) // meal table Entity represents a table within the database.
...
@Entity(tableName = "allergy_table", indices = [Index(value = ["strIngredient"], unique = true)])
data class Allergy(
    @PrimaryKey(autoGenerate = true)
    val id: Int,
